 ...
 */
final class Version20190304194205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE child_history (id INT UNSIGNED AUTO_INCREMENT NOT NULL, child_id INT UNSIGNED NOT NULL, sum NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_450E3850DD62C21B (child_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recurring_payments (id INT UNSIGNED NOT NULL, user_id INT UNSIGNED NOT NULL, withdrawal_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_F16E5623A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE referral_history (id INT UNSIGNED AUTO_INCREMENT NOT NULL, request_id INT UNSIGNED NOT NULL, user_id INT UNSIGNED NOT NULL, sum NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7E9A2C6D427EB8A5 (request_id), INDEX IDX_7E9A2C6DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
