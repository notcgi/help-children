 ...
 */
final class Version20200204222614 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ch_target CHANGE descr descr MEDIUMTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE attach attach MEDIUMTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE allowclose allowclose TINYINT(1) DEFAULT \'1\' NOT NULL');
    }
}
