 ...
 */
final class Version20190318121529 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE config (id INT AUTO_INCREMENT NOT NULL, percent_default NUMERIC(2, 2) NOT NULL, percent_recurrent NUMERIC(2, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
